...
update The Directory of Services (DOS) provides a searchable catalog of healthcare services appropriate to a person's urgent and emergency care (UEC) needs. It consists of a UI for data administrators and a number of APIs to interrogate the data and return appropriate services
